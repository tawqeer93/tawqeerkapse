...
public class GameScript : MonoBehaviour
{
    ...
    {
        Debug.Log("Dice roll received: " + diceRollResult);
        DiceRollButton.interactable = false;
    ...
    //{
    //    // Reset dice animations and visuals
    //    ResetDiceAnimations();  // You already have a method to reset dice animations
    //    Debug.Log("Dice has been reset due to timeout.");
    //}
